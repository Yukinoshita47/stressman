...
mkdir /pentest
echo ""
echo "creating stressman directory"
mkdir /pentest/stressman
echo ""
echo "copying Stressman Modules"
cp -r modules/ /pentest/stressman/
echo ""
echo "copying Stressman files stress.sh"
cp stress.sh /pentest/stressman/
echo ""
echo "copying Stressman files stressman"
cp stressman /pentest/stressman/
echo ""
echo "get inside pentest/stressman dir"
cd /pentest/stressman/
echo ""
